...
using MediatR;
using ValidationException = CorePackages.CrossCuttingConcerns.Exceptions.Types.ValidationException;
namespace CorePackages.Application.Pipelines.Validation;
